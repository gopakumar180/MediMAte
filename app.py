    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if pred < 0.5:
                ...
                pred = 1
            return render_template('resultbt.html', filename=filename, age=age, r=pred, gender=gender)
...
def resultd():
    if request.method == 'POST':
        ...
        return render_template('resultd.html', age=age, r=pred, gender=gender)
...
def resulth():
    if request.method == 'POST':
        ...
        return render_template('resulth.html', age=age, r=pred, gender=gender)
